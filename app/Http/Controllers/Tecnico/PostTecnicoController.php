...
class PostTecnicoController extends Controller
{
    ...
    {
        set_time_limit(5000);
        $response = Http::withToken(TokenServiceController::TOKEN_SEED)->timeout(0)->get(TokenServiceController::API_TEC);
    ...
    public function importTecnico($username)
    {
        date_default_timezone_set('America/Sao_Paulo');
        set_time_limit(5000);

        $diretorResponse = $this->getTecnico();
        ...
        foreach ($data as $usr) {
            ...
            if ($usr['username'] === $username) {
                ...
                $enrolmentStatus = $this->enrolUser($usrId, $courseId, $groupId);
        ...
        "</div>";
        //return $html;
        return view('tecnico', compact('html'));
    }
            ...
            'users' => [
                [
                    ...
                    'customfields' => [
                        ...
                        ['type' => 'descnre', 'value' => $userData['descnre']],
    ...
    private function enrolUser($usrId, $courseId, $groupId)
    {
